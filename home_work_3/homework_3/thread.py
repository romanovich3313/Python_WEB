...
parser.add_argument('-d', '--destination', default='dist', help='Path to destination folder.')
parser.add_argument('-t', '--threads', default='2', help='Count of threads for sorting.')
parser.add_argument('-rb', '--removebase', default='0', help='{any int} to remove the base folder, 0 to leave.')
